...
export default function IndustriesPage() {
  ...
  return (
    <>
      ...
      >
        <h1 className="text-5xl font-extrabold text-white mb-4 tracking-tight">{ip.title}</h1>
        <p style={{ color: "rgba(255,255,255,0.7)" }} className="max-w-xl mx-auto">{ip.subtitle}</p>
      </section>
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div
                    ...
                    style={{ background: "linear-gradient(to top,rgba(5,15,30,0.88),transparent 60%)" }}
                  />
                  <div className="absolute bottom-0 left-0 right-0 p-5 flex items-center gap-3">
                    <Icon size={18} color="white" strokeWidth={1.8} />
                    <span className="text-white font-bold text-lg">{ind.label}</span>
                  </div>
                </div>
